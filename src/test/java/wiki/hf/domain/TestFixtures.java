...
public class TestFixtures {
    ...
    public static Account LF_Owner()
    {
        return Account("Louis Ferro", "LF", "LouisFerro123456789!", AccountType.OWNER);
    }

    public static Account UK_Administrator()
    {
        return Account("Unger Klaus", "UK", "UngerKlaus123456789!", AccountType.ADMINISTRATOR);
    }

    public static Account AS_Editor()
    {
        return Account("Andreas Schenk", "AS", "AndreasSchenk123456789!", AccountType.EDITOR);
    }

    public static Account NH_Reader()
    {
        return Account("Niklas Hasenbacher", "NH", "NiklasHasenbacher123456789!", AccountType.EDITOR);
    }
    ...
    {
        return Action(LF_Owner(), LocalDateTime.of(2023, 12, 20, 12, 0, 0), ActionType.CREATION);
    }
    ...
    {
        return Action(LF_Owner(), LocalDateTime.of(1, 1, 1, 0, 0, 0), ActionType.CREATION);
    }
    ...
    public static Item FourMountainWalk_Page()
    {
        return item(null, null, "4 Mountain Walk", "What is the 4 Mountain Walk", Content.builder().text(null).build(), ItemType.PAGE,
                    Action(LF_Owner(), LocalDateTime.of(2023, 3, 5, 20, 30), ActionType.CREATION));
    }
    ...
    public static Item Generics_Text()
    {
        return item(FourMountainWalk_Page(), Introduction_Section(), "Introduction", null,
                ...
                ItemType.TEXT, Action(LF_Owner(), LocalDateTime.of(2023, 3, 5, 20, 30), ActionType.CREATION));
    }
    ...
    public static Item TableOfContents_List()
    {
        return item(FourMountainWalk_Page(), Introduction_Section(), "TableOfContents", "A list of all the sections and items", Content.builder().text(null).build(), ItemType.LIST,
                Action(LF_Owner(), LocalDateTime.of(2023, 3, 6, 8, 15), ActionType.CREATION));
    }
    ...
    public static Item Introduction_List()
    {
        return item(FourMountainWalk_Page(), TableOfContents_List(), "Introduction", null, Content.builder().text("1. Introduction").build(), ItemType.LIST,
                Action(LF_Owner(), LocalDateTime.of(2023, 3, 5, 8, 45), ActionType.CREATION));
    }
