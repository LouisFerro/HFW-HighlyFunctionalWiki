...
public class TestFixtures {
    ...
    public static Item Introduction_Text()
    {
        return item(FourMountainWalk_Page(), FourMountainWalk_Page(), "Introduction", null,
    ...
    {
        return item(FourMountainWalk_Page(), FourMountainWalk_Page(), "TableOfContents", "A list of all the sections and items", Content.builder().text(null).build(), ItemType.LIST,
